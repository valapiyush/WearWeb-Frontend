      ...
      <div className="billing-details">
        ...
        {address ? (
          <div className="address-display">
            ...
            <button className="add-address-btn" onClick={handleAddNewAddress}>Add Another Address</button>
          </div>
        ) : (
        ...
        {showAddressForm && (
          <form className="address-form" onSubmit={handleAddressSubmit}>
            ...
            <select className="edit-input" name="gender" value={newAddress.gender} onChange={handleAddressChange}>
          <option value="">Select Gender</option>
          <option value="Male">Male</option>
          <option value="Female">Female</option>
          <option value="Other">Other</option>
        </select>            <input type="number" name="age" placeholder="Age" value={newAddress.age} onChange={handleAddressChange} required />
            ...
            <select name="city_id" value={newAddress.city_id} onChange={handleAddressChange} required>
...
<select name="state_id" value={newAddress.state_id} onChange={handleAddressChange} required>
...
<select name="country_id" value={newAddress.country_id} onChange={handleAddressChange} required>
    ...
    <option key={country._id} value={country._id}>{country.name}</option>
      ...
      <div className="order-summary">
        ...
        <div className="summary-box">
          <div className="summary-item"><span>Subtotal</span><span>₹{subtotal.toLocaleString()}</span></div>
          <div className="summary-item"><span>Shipping Fee</span><span>₹{shippingFee}</span></div>
          <div className="summary-item"><span>Coupon</span><span>- ₹{discount}</span></div>
